		...
		<div class="product_attributes">
            <?php
                ...
                if ( $attribute_taxonomies ) {
                    foreach ( $attribute_taxonomies as $pos => $tax ) {
                        if ( in_array( $tax->attribute_id, explode( ',', get_option( 'wcvendors_hide_attributes_list' ) ) ) ) continue;  
                        $attribute_taxonomy_name = wc_attribute_taxonomy_name( $tax->attribute_name );
                        $label = $tax->attribute_label ? $tax->attribute_label : $tax->attribute_name;
                        
                        $new_attributes[$attribute_taxonomy_name] = [
                ...
                $attributes = array_merge($new_attributes, $attributes);
