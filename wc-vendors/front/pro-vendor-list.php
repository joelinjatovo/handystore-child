	...
	<div class="wcv-store-grid row">
		...
		<div class="wcv-banner-wrapper hidden-xs col-sm-4 col-md-2">
			...
			<div class="wcv-banner-inner">
					<div class="wcv-icon-container">
                        <?php 
                            if ($store_icon) { echo $store_icon; }
						    else { echo $store_icon 	= '<img src="'.site_url('/wp-content/themes/handystore-child/assets/img/vendor.png').'" alt="'.esc_attr($vendor_meta['pv_shop_name']).'" class="store-icon" />'; } 
                        ?>
					</div>
		...
		<div class="wcv-description-wrapper col-xs-12 col-sm-8 col-md-4">
			...
			<div class="wcv-description-inner">
				...
				<?php if ($address && $address!='') echo '<span class="vendor-address" style="width: 100%; margin-left: 20px;"><i class="fa fa-map-marker" aria-hidden="true"></i>'.$address_label.'</span>'; ?>
                <?php if ($phone != '')  { ?><span class="vendor-phone" style="width: 100%; margin-left: 20px;"><a href="tel:<?php echo $phone; ?>"><i class="fa fa-phone"></i><?php echo $phone; ?></a></span><?php } ?>
				<div class="short-description"><?php echo $vendor_meta[ 'pv_shop_description' ]; ?></div>
				<a href="<?php echo $shop_link; ?>" class="button" rel="nofollow"><?php esc_html_e('Visit Store', 'plumtree'); ?></a>
			</div>
